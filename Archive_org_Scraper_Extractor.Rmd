...
for (i in seq_along(urls)) {
  ...
  # Open the page
  b$Page$navigate(url)$wait()  # Navigate and wait until the page loads

  # Save the page as a PDF
  pdf_data <- b$Page$printToPDF()$wait()  # Get the PDF binary data
  writeBin(pdf_data$data, filename)  # Save the binary data to a PDF file
