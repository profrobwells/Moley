...
newsweek_43_45_clean <- gsub("c\\(\"|\"\\)|\\n", "", newsweek_43_45)
```

#Cleaning sequence
```{r}
x_clean <- newsweek_43_45_clean
...
download_directory <- file.path(path.expand("~"), 'Code', 'Moley', 'Newsweek_1941_pt2')
...
pdf_folder <- "/Users/robwells/Library/CloudStorage/Dropbox/Current_Projects/Moley project 2024/Newsweek/Newsweek_1938_41"
