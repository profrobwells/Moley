...
chat2 <- chat_gemini(
  ...
  2. If an article contains two or more mentions of vote or voter registration, classify it as 'voter_turnout'
  3. If an article contains two or more mentions the economic developments, classify it as 'economy'
  4. If an article contains two or more mentions of business issues, classify it as 'business'. 'Business issues' would be defined as articles mentioning companies, executives, business activity, financial dealings, industry, 
  5. If an article contains two or more mentions the organized labor, classify it as 'labor'. 'Organized labor' would be defined as xxxxxx
