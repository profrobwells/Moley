---
title: "Analysis of Business Narratives Raymond Moley’s Reporting from 1937 - 1968"
author: "Rob Wells and Bridget Lang"
date: '2025-6-19'
output: html_document
---

This notebook extends the analysis from "moley_text_analysius_feb_14_2025.rmd" by focusing on specific business and economic narratives over time..
...
scale_x_continuous(breaks = seq(1941, 1964, by = 1)) +
  ...
  labs(title = "'Statism' in Raymond Moley Newsweek Articles, 1937-1967",
       subtitle = "Analysis of 1,487 Newsweek columns",
       x = "Year",
       y = "Frequency",
       caption = "Source: Newsweek. Graphic by Rob Wells, 6-19-2025")

ggsave("output/statism_newsweek_6-19_2025.png", device = "png", width = 9, height = 6, dpi = 800)
...
scale_x_continuous(breaks = seq(1937, 1966, by = 1)) +
  theme(legend.position="none",
        axis.text.x = element_text(angle = 90, hjust = 1)) +
  geom_text(aes(label=n), vjust = -.5, size=3) +
  labs(title = "Free Enterprise in Raymond Moley Newsweek Articles, 1937-1967",
       subtitle = "Analysis of 1,487 Newsweek columns",
       x = "Year",
       y = "Frequency",
       caption = "Free enterprise and six variants of phrase. Source: Newsweek. Graphic by Rob Wells, 6-19-2025")

ggsave("output/free_enterprise_newsweek_6-19_2025.png", device = "png", width = 9, height = 6, dpi = 800)
...
scale_x_continuous(breaks = seq(1937, 1967, by = 1)) +
  theme(legend.position="none",
        axis.text.x = element_text(angle = 90, hjust = 1)) +
  geom_text(aes(label=n), vjust = -.5, size=3) +
  labs(title = "Marxism in Raymond Moley Newsweek Articles, 1937-1967",
       subtitle = "Analysis of 1,487 Newsweek columns",
       x = "Year",
       y = "Frequency",
       caption = "Marxism, communism, socialism. Source: Newsweek. Graphic by Rob Wells, 6-19-2025")

ggsave("output/marxism_newsweek_6-19_2025.png", device = "png", width = 9, height = 6, dpi = 800)
...
scale_x_continuous(breaks = seq(1937, 1967, by = 1)) +
  theme(legend.position="none",
        axis.text.x = element_text(angle = 90, hjust = 1)) +
  geom_text(aes(label=n), vjust = -.5, size=3) +
  labs(title = "Bureaucracy in Raymond Moley Newsweek Articles, 1937-1967",
       subtitle = "Analysis of 1,487 Newsweek columns",
       x = "Year",
       y = "Frequency",
       caption = "Source: Newsweek. Graphic by Rob Wells, 6-19-2025")

ggsave("output/bureaucracy_newsweek_6-19_2025.png", device = "png", width = 9, height = 6, dpi = 800)
...
scale_x_continuous(breaks = seq(1937, 1967, by = 1)) +
  theme(legend.position="none",
        axis.text.x = element_text(angle = 90, hjust = 1)) +
  geom_text(aes(label=n), vjust = -.5, size=3) +
  labs(title = "Government Spending Topics in Raymond Moley Newsweek Articles, 1937-1967",
       subtitle = "Analysis of 1,487 Newsweek columns",
       x = "Year",
       y = "Frequency",
       caption = "Source: Newsweek. Graphic by Rob Wells, 6-19-2025")

ggsave("output/spending_newsweek_6-19_2025.png", device = "png", width = 9, height = 6, dpi = 800)
...
articles_text %>%
  ...
  mutate(
    percentage = round((count / 1487) * 100, digits =1)
) %>%
  arrange(desc(count))
```
